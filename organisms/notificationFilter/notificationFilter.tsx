...
import { NotificationsFilter } from 'types/filters';
...
const NotificationFilter = observer(({ store }: Props) => {
    ...
    const handleSortChange = (value: NotificationsFilter['sortBy']) => {
    ...
    const handleDeletedItems = (value: NotificationsFilter['deleted']) => {
